...
home.homeDirectory = "/home/norrman";
    ...
    # home.file.".config/greetd/config.toml" = {
    # text = ''
    #     [greeter]
    #     session = "sway"
    #     command ="sway"
...
$terminal = ghostty
$fileManager = dolphin
$menu = wofi --show drun --style=$HOME/.config/hypr/wofi_styles.css
# $menu = anyrun 
...
general {
    ...
    # col.active_border = rgb(97971a) # green
    # col.active_border = rgb(fe8019) # light orange
    col.active_border = rgba(d65d0e99) rgba(fe801999) 45deg # dark 45deg orange
...
# changed
# bind = Print, slurp | grim -g - $HOME/Desktop/screenshot.jpg
...
monitor=,preferred,auto,1
 ...
 # exec-once = tmux setenv -g HYPRLAND_INSTANCE_SIGNATURE "$HYPRLAND_INSTANCE_SIGNATURE" 
    ...
    # lib.configDefault = "/home/norrman/Dotfiles/sway/config";
